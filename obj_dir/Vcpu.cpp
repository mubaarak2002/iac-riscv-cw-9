...
Vcpu::Vcpu(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , ZERO_Out{vlSymsp->TOP.ZERO_Out}
    , RA1_Out{vlSymsp->TOP.RA1_Out}
    , RA2_Out{vlSymsp->TOP.RA2_Out}
    , PCsrc_Out{vlSymsp->TOP.PCsrc_Out}
    , Resultsrc_Out{vlSymsp->TOP.Resultsrc_Out}
    , MemWrite_Out{vlSymsp->TOP.MemWrite_Out}
    , ALUctrl_Out{vlSymsp->TOP.ALUctrl_Out}
    , ALUsrc_Out{vlSymsp->TOP.ALUsrc_Out}
    , Immsrc_Out{vlSymsp->TOP.Immsrc_Out}
    , RegWrite_Out{vlSymsp->TOP.RegWrite_Out}
    , WrAddr_Out{vlSymsp->TOP.WrAddr_Out}
    , PC_Out{vlSymsp->TOP.PC_Out}
    , PC_Target_Out{vlSymsp->TOP.PC_Target_Out}
    , PC_new_Out{vlSymsp->TOP.PC_new_Out}
    , Decode_PC_Out{vlSymsp->TOP.Decode_PC_Out}
    , ImmExt_Out{vlSymsp->TOP.ImmExt_Out}
    , Instruction_Out{vlSymsp->TOP.Instruction_Out}
    , RD1_Out{vlSymsp->TOP.RD1_Out}
    , RD2_Out{vlSymsp->TOP.RD2_Out}
    , MemAddr_Out{vlSymsp->TOP.MemAddr_Out}
