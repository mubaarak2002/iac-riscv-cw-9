...
VL_ATTR_COLD void Vcpu___024root__trace_init_sub__TOP__0(Vcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+72,"ImmExt_Out", false,-1, 31,0);
    tracep->declBus(c+73,"PC_Out", false,-1, 15,0);
    tracep->declBus(c+74,"PC_Target_Out", false,-1, 15,0);
    tracep->declBus(c+75,"Instruction_Out", false,-1, 31,0);
    tracep->declBus(c+76,"PC_new_Out", false,-1, 15,0);
    tracep->declBus(c+77,"RD1_Out", false,-1, 31,0);
    tracep->declBus(c+78,"RD2_Out", false,-1, 31,0);
    tracep->declBus(c+79,"MemAddr_Out", false,-1, 31,0);
    tracep->declBus(c+80,"MemData_Out", false,-1, 31,0);
    tracep->declBit(c+81,"ZERO_Out", false,-1);
    tracep->declBus(c+82,"RA1_Out", false,-1, 4,0);
    tracep->declBus(c+83,"RA2_Out", false,-1, 4,0);
    tracep->declBit(c+84,"PCsrc_Out", false,-1);
    tracep->declBit(c+85,"Resultsrc_Out", false,-1);
    tracep->declBit(c+86,"MemWrite_Out", false,-1);
    tracep->declBus(c+87,"ALUctrl_Out", false,-1, 3,0);
    tracep->declBit(c+88,"ALUsrc_Out", false,-1);
    tracep->declBus(c+89,"Immsrc_Out", false,-1, 2,0);
    tracep->declBit(c+90,"RegWrite_Out", false,-1);
    tracep->declBus(c+91,"ImmOp_Out", false,-1, 24,0);
    tracep->declBus(c+92,"Decode_PC_Out", false,-1, 15,0);
    tracep->declBus(c+93,"WrAddr_Out", false,-1, 4,0);
    tracep->declBus(c+94,"Data_Out", false,-1, 31,0);
    ...
    tracep->declBus(c+63,"PC_Next_Cycle", false,-1, 15,0);
    ...
    tracep->declBus(c+64,"Instruction", false,-1, 31,0);
    ...
    tracep->declBus(c+25,"Imm", false,-1, 24,0);
    ...
    tracep->declBus(c+27,"ALUopcode", false,-1, 3,0);
    tracep->declBus(c+28,"r0", false,-1, 4,0);
    tracep->declBus(c+29,"branchcode", false,-1, 2,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+98,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+97,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+63,"PC", false,-1, 15,0);
    tracep->declBus(c+64,"instr", false,-1, 31,0);
    tracep->declBus(c+65,"instrByte1", false,-1, 7,0);
    tracep->declBus(c+66,"instrByte2", false,-1, 7,0);
    tracep->declBus(c+67,"instrByte3", false,-1, 7,0);
    tracep->declBus(c+68,"instrByte4", false,-1, 7,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+1,"PC_Target", false,-1, 15,0);
    tracep->declBus(c+63,"PC", false,-1, 15,0);
    tracep->declBus(c+69,"inc_PC", false,-1, 15,0);
    ...
    tracep->declBus(c+11,"RD2", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+31+i*1,"rom_array", true,(i+0), 31,0);
    }
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vcpu___024root__trace_full_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+22,(vlSelf->cpu__DOT__Decoder__DOT__rd),5);
    bufp->fullCData(oldp+23,(vlSelf->cpu__DOT__Decoder__DOT__rs1),5);
    bufp->fullCData(oldp+24,(vlSelf->cpu__DOT__Decoder__DOT__rs2),5);
    bufp->fullIData(oldp+25,(vlSelf->cpu__DOT__Decoder__DOT__Imm),25);
    bufp->fullCData(oldp+26,(vlSelf->cpu__DOT__Decoder__DOT__opcode),7);
    ...
    bufp->fullIData(oldp+34,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[3]),32);
    bufp->fullIData(oldp+35,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[4]),32);
    bufp->fullIData(oldp+36,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[5]),32);
    bufp->fullIData(oldp+37,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[6]),32);
    bufp->fullIData(oldp+38,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[7]),32);
    bufp->fullIData(oldp+39,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[8]),32);
    bufp->fullIData(oldp+40,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[9]),32);
    bufp->fullIData(oldp+41,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[10]),32);
    bufp->fullIData(oldp+42,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[11]),32);
    bufp->fullIData(oldp+43,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[12]),32);
    bufp->fullIData(oldp+44,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[13]),32);
    bufp->fullIData(oldp+45,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[14]),32);
    bufp->fullIData(oldp+46,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[15]),32);
    bufp->fullIData(oldp+47,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[16]),32);
    bufp->fullIData(oldp+48,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[17]),32);
    bufp->fullIData(oldp+49,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[18]),32);
    bufp->fullIData(oldp+50,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[19]),32);
    bufp->fullIData(oldp+51,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[20]),32);
    bufp->fullIData(oldp+52,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[21]),32);
    bufp->fullIData(oldp+53,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[22]),32);
    bufp->fullIData(oldp+54,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[23]),32);
    bufp->fullIData(oldp+55,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[24]),32);
    bufp->fullIData(oldp+56,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[25]),32);
    bufp->fullIData(oldp+57,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[26]),32);
    bufp->fullIData(oldp+58,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[27]),32);
    bufp->fullIData(oldp+59,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[28]),32);
    bufp->fullIData(oldp+60,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[29]),32);
    bufp->fullIData(oldp+61,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[30]),32);
    bufp->fullIData(oldp+62,(vlSelf->cpu__DOT__RegFile__DOT__rom_array[31]),32);
    bufp->fullSData(oldp+63,(vlSelf->cpu__DOT__PC_Next_Cycle),16);
    bufp->fullIData(oldp+64,(vlSelf->cpu__DOT__Instr),32);
    bufp->fullCData(oldp+65,(vlSelf->cpu__DOT__PCMem__DOT__instrByte1),8);
    bufp->fullCData(oldp+66,(vlSelf->cpu__DOT__PCMem__DOT__instrByte2),8);
    bufp->fullCData(oldp+67,(vlSelf->cpu__DOT__PCMem__DOT__instrByte3),8);
    bufp->fullCData(oldp+68,(vlSelf->cpu__DOT__PCMem__DOT__instrByte4),8);
    bufp->fullSData(oldp+69,((0xffffU & ((IData)(4U) 
                                         + (IData)(vlSelf->cpu__DOT__PC_Next_Cycle)))),16);
    bufp->fullBit(oldp+70,(vlSelf->clk));
    bufp->fullBit(oldp+71,(vlSelf->rst));
    bufp->fullIData(oldp+72,(vlSelf->ImmExt_Out),32);
    bufp->fullSData(oldp+73,(vlSelf->PC_Out),16);
    bufp->fullSData(oldp+74,(vlSelf->PC_Target_Out),16);
    bufp->fullIData(oldp+75,(vlSelf->Instruction_Out),32);
    bufp->fullSData(oldp+76,(vlSelf->PC_new_Out),16);
    bufp->fullIData(oldp+77,(vlSelf->RD1_Out),32);
    bufp->fullIData(oldp+78,(vlSelf->RD2_Out),32);
    bufp->fullIData(oldp+79,(vlSelf->MemAddr_Out),32);
    bufp->fullIData(oldp+80,(vlSelf->MemData_Out),32);
    bufp->fullBit(oldp+81,(vlSelf->ZERO_Out));
    bufp->fullCData(oldp+82,(vlSelf->RA1_Out),5);
    bufp->fullCData(oldp+83,(vlSelf->RA2_Out),5);
    bufp->fullBit(oldp+84,(vlSelf->PCsrc_Out));
    bufp->fullBit(oldp+85,(vlSelf->Resultsrc_Out));
    bufp->fullBit(oldp+86,(vlSelf->MemWrite_Out));
    bufp->fullCData(oldp+87,(vlSelf->ALUctrl_Out),4);
    bufp->fullBit(oldp+88,(vlSelf->ALUsrc_Out));
    bufp->fullCData(oldp+89,(vlSelf->Immsrc_Out),3);
    bufp->fullBit(oldp+90,(vlSelf->RegWrite_Out));
    bufp->fullIData(oldp+91,(vlSelf->ImmOp_Out),25);
    bufp->fullSData(oldp+92,(vlSelf->Decode_PC_Out),16);
    bufp->fullCData(oldp+93,(vlSelf->WrAddr_Out),5);
    bufp->fullIData(oldp+94,(vlSelf->Data_Out),32);
